...
def click_Restaurant():
    call(["python","Restaurant Service.py"])


class HOTEL_MANAGEMENT:
    def __init__(self):
        root = Tk()
        _bgcolor = '#B0E0E6'  #  'powderblue'
        ...
        root.configure(background="#87CEFA")   # 'lightskyblue'
        root.configure(highlightbackground="#4169E1") # 'royalblue'
        ...
        self.Frame1.configure(relief=GROOVE)
        self.Frame1.configure(background="#2e9ea1")   # 'pale cyan'
        self.Frame1.configure(highlightbackground="#483D8B")   # 'darkslateblue'
        self.Frame1.configure(highlightcolor="black")
        self.Frame1.configure(width=925)

        self.Message6 = Message(self.Frame1)
        self.Message6.place(relx=0.09, rely=0.01, relheight=0.15, relwidth=0.86)
        self.Message6.configure(background="#2e9ea1")  # 'pale cyan'
        self.Message6.configure(font=font16)
        self.Message6.configure(foreground="#000000")
        self.Message6.configure(highlightbackground="#483D8B")   # 'darkslateblue'
        ...
        self.Button2.configure(background="#d4f1ff")   # 'greenish white'
        ...
        self.Button3.configure(activebackground="#4682B4")  # 'steelblue'
        self.Button3.configure(activeforeground="#000000")
        self.Button3.configure(background="#d4f1ff")   # 'greenish white'
        self.Button3.configure(disabledforeground="#bfbfbf")
        self.Button3.configure(font=font14)
        self.Button3.configure(foreground="#000000")
        self.Button3.configure(highlightbackground="#483D8B")  # 'darkslateblue'
        ...
        self.Button4.configure(activebackground="#4682B4")  # 'steelblue'
        self.Button4.configure(activeforeground="#000000")
        self.Button4.configure(background="#d4f1ff")  # 'greenish white'
        self.Button4.configure(disabledforeground="#bfbfbf")
        self.Button4.configure(font=font14)
        self.Button4.configure(foreground="#000000")
        self.Button4.configure(highlightbackground="#483D8B")  # 'darkslateblue'
        ...
        self.Button5.configure(activebackground="#4682B4")  # 'steelblue'
        self.Button5.configure(activeforeground="#000000")
        self.Button5.configure(background="#d4f1ff")  # 'greenish white'
        self.Button5.configure(disabledforeground="#bfbfbf")
        self.Button5.configure(font=font14)
        self.Button5.configure(foreground="#000000")
        self.Button5.configure(highlightbackground="#483D8B") # 'darkslateblue'
        self.Button5.configure(highlightcolor="black")
        self.Button5.configure(pady="0")
        self.Button5.configure(text='''4.RESTAURANT SERVICES''')
        self.Button5.configure(width=566)
        self.Button5.configure(command=click_Restaurant)

        self.Button6 = Button(self.Frame1)
        self.Button6.place(relx=0.18, rely=0.77, height=103, width=566)
        self.Button6.configure(activebackground="#49636f")  # 'steelblue'
        self.Button6.configure(activeforeground="#000000")
        self.Button6.configure(background="#d4f1ff")  # 'greenish white'
        self.Button6.configure(disabledforeground="#bfbfbf")
        self.Button6.configure(font=font14)
        self.Button6.configure(foreground="#000000")
        self.Button6.configure(highlightbackground="#483D8B")  # 'darkslateblue'
