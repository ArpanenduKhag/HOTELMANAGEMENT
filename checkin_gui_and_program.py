    ...
    def __init__(self):
        ...
        def tor(self):
            ...
            if self.ch == 1:
                ...
                self.price = self.price + (1100 * self.no_of_days)
                m[0] = 2
            elif self.ch == 3:
        ...
        root.title("HOTEL MANGMENT Programme by AK")
        ...
        self.Message1.configure(width=495)
        ...
        self.Label3.place(relx=0.05, rely=0.03, height=47, width=287)
        ...
        self.Label4.place(relx=0.045, rely=0.29, height=47, width=320)
        ...
        self.Button4.configure(activebackground="#1E90FF")  # 'dodgerblue'
        self.Button4.configure(activeforeground="#1E90FF")  # 'dodgerblue'
        self.Button4.configure(background="#B0C4DE") # 'lightsteelblue'
